...
function ProjectLink({ link, projectId }: { link: ProjectLink; projectId: string }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`project-link ${slug === "live-demo" ? "project-link--primary" : "project-link--outline"}`}
      id={`${projectId}-${slug}`}
    >
    ...
    >
      <div className="container">
        ...
        <p className="section__subtitle">
          Two deployed, production-style full-stack applications
        </p>
